...
\customtitle{Fluctuation Strength Experiment Protocol}
...
% subsection before (end)

\subsection{During} % (fold)
\label{sub:during}
...
% subsection during (end)

\subsection{After} % (fold)
\label{sub:after}
...
\section{Prompts} % (fold)
\label{sec:prompts}

\subsection{Training Phase} % (fold)
...
% subsection training_phase (end)

\subsection{Before Rough Tones} % (fold)
...
% subsection before_rough_tones (end)

\subsection{After Rough Tones} % (fold)
...
% subsection after_rough_tones (end)

\subsection{Long Stimuli} % (fold)
...
% subsection long_stimuli (end)

\subsection{Test Trials} % (fold)
...
% subsection test_trials (end)

\subsection{Before Sections} % (fold)
...
% subsection before_sections (end)
