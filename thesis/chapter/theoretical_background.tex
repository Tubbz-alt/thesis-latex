...
in \Cref{fig:flucstrenvsmoddep}. For \gls{AM} tones the modulation depth is
...
\Cref{eq:theo_fm}, where $A$ corresponds to the carrier signal amplitude.
...
\begin{figure}[!ht]
  ...
  \caption{Fluctuation strength of sounds 1--5 as described in
    \Cref{tab:flucstrensnds}. Replotted from
