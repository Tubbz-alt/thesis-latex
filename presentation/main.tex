...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \begin{itemize}
      ...
      \pause{}
      \item Musicality (instruments sound quality and naturalness)
    \end{itemize}
  \end{itemize}
\end{frame}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \begin{enumerate}
          ...
          \item<5-> Specific fluctuation stage
        \end{enumerate}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[height=0.75\textheight]{model_roughness}
    \caption{Roughness of AM tones, as presented by
